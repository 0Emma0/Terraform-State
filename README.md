...
When using [workspaces](https://developer.hashicorp.com/terraform/language/state/workspaces), the state for the `default` workspace is stored at the location described above.
